...
const QuoteBox = ({ quote, setQuote }) => {
  ...
  return (
    <section className="infogalax">
      <div className="infogalax-container">
        <header className="infogalax-header">
          <h1 className="infogalax-header-title">INFOGALAX</h1>
        </header>
        <main className="infogalax-main">
          <p className="infogalax-main-phrase">{phrase}</p>
          <button className="infogalax-main-buttom" onClick={setQuote}>
            <svg
              width="67"
              height="67"
              viewBox="0 0 67 67"
              ...
              <defs>
                ...
                >
                  ...
                  <feBlend
                    ...
                    result="effect1_dropShadow_171_1501"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect1_dropShadow_171_1501"
                    result="shape"
                  />
                </filter>
              </defs>
      ...
      <footer className="infogalax-footer">
        <p className="infogalax-footer-author">{author}</p>
      </footer>
    </section>
  );
};
